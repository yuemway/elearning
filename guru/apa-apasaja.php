                    ...
                    <div class="col-sm-6 col-md-4 mb-3">
                        <div class="card h-100 shadow">
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-secondary shadow2 warna1 font form-control">Lihat Detail<object style="height: 5px;" data="Nama-Nama Kelompok PROFESI PENDIDIK.pdf"></object></button>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
